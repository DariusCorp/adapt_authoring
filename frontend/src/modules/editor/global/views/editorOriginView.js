  ...
  var EditorOriginView = OriginView.extend({
    ...
    initialize: function (options) {
      ...
      this.listenTo(Origin, {
        ...
        'sidebarFieldsetFilter:hideForm': this.hideForm,
    ...
    hideForm: function (filter) {
      console.log(filter);
      console.log($('fieldset[data-key=' + filter + ']'));
      $('fieldset[data-key=' + filter + ']').addClass('display-none');
    },
